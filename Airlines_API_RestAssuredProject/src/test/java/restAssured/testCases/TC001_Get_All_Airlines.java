...
Test Name:Get all Airlines data
...
public class TC001_Get_All_Airlines extends BaseClass
{
	@BeforeClass
	public void getAirlineData()
	{
		logger.info("*********TC001_Get_All_Airlines**********");
		
		RestAssured.baseURI ="https://api.instantwebtools.net/v1";
		httprequest = RestAssured.given();
		response = httprequest.request(Method.GET, "/airlines");
	}
	...
	{
		logger.info("*********Finished TC001_Get_All_Airlines**********");
	}
}
