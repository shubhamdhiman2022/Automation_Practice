...
public class TC004_Get_Passenger_By_ID extends BaseClass
{
	@BeforeClass
	public void getPassengerData()
	{
		String passenger_id= read.get_passenger_get_id();
		logger.info("*********Started TC004_Get_Passenger_By_ID**********");
		RestAssured.baseURI= "https://api.instantwebtools.net/v1";
		httprequest =RestAssured.given();
		response = httprequest.request(Method.GET, "/passenger/"+passenger_id);
	}
	...
	{
		logger.info("*********Finished TC004_Get_Passenger_By_ID**********");
	}
}
