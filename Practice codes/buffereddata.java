				...
				// TODO Auto-generated method stub
						 ...
						 */
						 ...
						 /* System.out.println("Total no. of Related items that you have searched availabe on Website is: " +ttl); 
						  ...
						  br.write("Title of the website: " + title);br.newLine();
							br.write("Total no. of Related items that you have searched availabe on Website is: " +ttl);br.newLine();
							br.write("===================Page No. :1===================");br.newLine();
							br.write("No. of data id's: "+id.size());br.newLine();
							br.write("Size of data fetch: "+value.size());br.newLine();
							br.write("Start from: "+stpt);br.newLine();
							br.write("End to: "+edpt);br.newLine();
							br.write("Total items on page: "+ttl);br.newLine();
							br.newLine();
						  ...
						  for(int i=0;i<value.size();i++) 
						  {
							 /* System.out.println("item no."+stpt++);
							  ...
							  System.out.println("=======================");*/
								  ...
								  br.write("item.no."+stpt++); br.newLine();
						  ...
						  value =driver.findElements(By.className("result-info")); 
						  id= driver.findElements(By.className("result-title"));
						  start = driver.findElement(By.className("rangeFrom"));
						  end = driver.findElement(By.className("rangeTo"));
						  total = driver.findElement(By.className("totalcount"));
						  

							a = start.getText();
							b = end.getText();
							c = total.getText();
							stpt = Integer.parseInt(a);
							edpt = Integer.parseInt(b);
							ttl = Integer.parseInt(c);
						 ...
						 /* System.out.println();
						  ...
						  System.out.println(ttl);*/
							...
							br.write("===================Page No. :"+(pageno+1)+"===================");br.newLine();
							br.write("No. of data id's: "+id.size());br.newLine();
							br.write("Size of data fetch: "+value.size());br.newLine();
							br.write("Start from: "+stpt);br.newLine();
							br.write("End to: "+edpt);br.newLine();
						  ...
						  br.write("Total "+ttl+" items data has been fetched successfully");
						  br.close();
